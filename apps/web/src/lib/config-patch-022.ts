...
// 🔹 wagmi v2 Hooks (исправлено:  => data)
...
// 🔹 Чтение баланса (ИСПРАВЛЕНО: безопасная индексация через as any)
export function useGameBalance(id: string | null) {
  ...
  // 🔥 FIX: data может быть undefined или объектом, приводим к any для индексации
