...
export const CONFIG={
  ...
  ...PATCH_010,...PATCH_011,...PATCH_014
};

// 🔹 ЭКСПОРТЫ: Всё, что нужно page.tsx (и старое, и новое)
...
// 🟢 Логика Контрактов (Патч 014 - новая)
export const MIN_STAKE=CONFIG.MIN_STAKE;
export const C4C_DECIMALS=CONFIG.C4C_DECIMALS;
